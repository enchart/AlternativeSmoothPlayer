...
internal static class Patch
{
    ...
    {
        var visual = __instance.transform.Find("Player");
        visual.position = Vector3.Lerp(visual.position, __instance.Player_Rigidbody.transform.position,
        ...
        if (vector.x < num || vector.x > 1f - num || vector.y < edgeOffset || vector.y > 1f - edgeOffset)
        {
            ...
            visual.position = Vector3.Lerp(visual.position, __instance.ObjectCamera.ViewportToWorldPoint(vector),
